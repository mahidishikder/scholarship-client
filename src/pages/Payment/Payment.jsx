...
function Payment() {
  ...
  const { applicationFees, university_name, scholarship_category, subject_category, } = location.state || {};
    ...
    <div className="my-32">
      ...
      <div>
        <Elements stripe={stripePromise}>
          <CheckoutForm price={price} UName={UName} SCategory={SCategory} SubCategory={SubCategory} />
        </Elements>
      </div>
    </div>
  );
