...
function About() {
  return (
    <>
      ...
      {/* Main Container */}
      <motion.div
        className="min-h-screen bg-gradient-to-b from-red-100 to-slate-100 dark:from-gray-900 dark:to-gray-800 px-6 py-12 flex flex-col items-center"
        initial={{ opacity: 1 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        {/* Subtitle */}
        <motion.p
          className="text-gray-600 dark:text-white/70 text-lg text-center max-w-3xl mb-12"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl">
          ...
          >
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-4">Our Vision</h2>
            <p className="text-gray-600 dark:text-white/70">
          ...
          >
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-4">Our Values</h2>
            <p className="text-gray-600 dark:text-white/70">
